...
const Login = () => {
  ...
  return (
    <div className="w-full max-w-md p-6 bg-[#0909096a]  text-white rounded-lg shadow-lg transition-all duration-500">
      <h2 className="md:text-4xl text-3xl text-center font-semibold mb-4 " ref={errorMsg}>LOGIN</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {
            loading ? <BeatLoader loading={loading} color='white' size={10} speedMultiplier={1.2} /> : "Login"
          }
        </button>
      </form>
    </div>
